...
echo ""
echo "功能模块:"
echo -e "${GRAY}  - 健康问答: AI医疗咨询${NC}"
echo -e "${GRAY}  - 报告解读: 体检报告分析${NC}"
echo -e "${GRAY}  - 肺部CT 3D可视化: DICOM/MHD文件体绘制${NC}"
echo ""
echo "后续步骤:"
...
echo ""
echo "肺部CT测试数据:"
echo -e "${GRAY}  - LUNA16: https://luna16.grand-challenge.org/Data/${NC}"
echo -e "${GRAY}  - LIDC-IDRI: https://www.cancerimagingarchive.net/collection/lidc-idri/${NC}"
echo ""
echo "常用命令:"
